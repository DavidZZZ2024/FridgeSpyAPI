    ...
    <>
      ...
      <main className="container main-content">
        ...
        <section id="results" className="results-section" aria-live="polite">
          ...
          {loading && <div className="status-card"><LoadingState label="Checking the latest prices…" /><p>This may take a moment while the market data loads.</p></div>}
          {!loading && error && <div className="status-card"><ErrorState message={error} onRetry={() => loadProducts(filters)} /></div>}
